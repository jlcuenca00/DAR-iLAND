...
class MonitoringReportController extends Controller
{
    ...
    private function buildReportData(): array
    {
        ...
        return [
            ...
            'scopeNotice' => 'This report is generated for administrative monitoring and decision-support purposes only. A released clearance or denied application result does not automatically transfer land ownership, mutate parcel ownership records, or replace separate legal and administrative procedures.',
        ];
    }
}
