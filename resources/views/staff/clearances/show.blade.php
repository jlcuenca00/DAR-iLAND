    ...
    <div class="toolbar">
        <div class="toolbar-inner">
            <div class="toolbar-left">
                <a href="{{ route('staff.applications.show', $application) }}" class="btn">Back to Application</a>
                <span class="toolbar-title">Clearance Output Preview</span>
            </div>
            <div class="toolbar-right">
                <a href="{{ route('staff.applications.clearance.pdf', $application) }}" class="btn primary" target="_blank">Open LTC Form No. 5 PDF</a>
        ...
        <div class="page">
            ...
            <section class="decision-panel">
                <div class="decision-box {{ $decisionClass }}">
                    ...
                    <div class="decision-note">Internal system status remains released/denied for workflow tracking; the official form decision is shown as approved/denied.</div>
                </div>
                <div class="info-card">
