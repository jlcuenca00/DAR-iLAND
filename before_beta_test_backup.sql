...
\restrict hXwmdUdOsxO5YpvhEZSIzraBzIyvWWaqEdaqe2kEecySsxbGIUSwoUZYRYOdhHm
...
--
-- Name: application_clearances_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: application_clearances_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: application_parcels; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: application_parcels_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: application_parcels_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: landholdings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: landholdings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: landholdings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: landowners; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: landowners_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: landowners_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: legacy_records; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: application_clearances id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: application_parcels id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: landholdings id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: landowners id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: legacy_records id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages id; Type: DEFAULT; Schema: public; Owner: -
--
...
1	1	6	INDIVIDUAL GRADE REPORT.pdf	application-documents/1/iiUM8NXYgIvvoMqanObqumKIel9nBIRfLJJptneP.pdf	\N	1	\N	2026-07-03 15:13:51	2026-07-03 15:13:51	\N	\N	\N	\N	\N	\N
\.


--
-- Data for Name: application_parcels; Type: TABLE DATA; Schema: public; Owner: -
--
...
1	1	1	App\\Models\\LandTransferApplication	1	application_created	{"status":"pending_legal_review","applicant_name":"Jake Cuenca","applicant_type":"transferee","or_number":null,"transfer_nature":null,"is_succession_case":false,"retention_certificate_required":false,"retention_certificate_reference":null,"transferor_name":"Pedro Aquino","transferee_name":"Jake Cuenca","parcel_id":null,"scope_note":"Application encoding only. No ownership transfer or registry mutation was performed."}	127.0.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36	2026-06-24 20:29:06	2026-06-24 20:29:06
2	1	1	App\\Models\\ApplicationDocument	1	document_uploaded	{"required_document_id":6,"required_document_name":"Affidavit of Transferor","original_filename":"INDIVIDUAL GRADE REPORT.pdf","annex_reference":null,"document_reference_number":null,"document_metadata":null,"source_record_id":null,"source_record_package_id":null,"file_replaced":true,"scope_note":"Document\\/source record linking is for traceability and review only. No ownership transfer or registry mutation was performed."}	127.0.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36	2026-07-03 15:13:51	2026-07-03 15:13:51
3	1	1	App\\Models\\Landowner	1	landowner_record_created_from_application_party	{"party":"transferor","display_party":"Transferor","source_name":"Pedro Aquino","created_landowner_id":1,"linked_field":"transferor_landowner_id","scope_note":"A landowner\\/person record was created for application processing and traceability only. This does not transfer ownership, create a landholding, assign a parcel, or mutate registry records."}	127.0.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36	2026-07-03 15:27:39	2026-07-03 15:27:39
\.
...
--
-- Data for Name: land_transfer_applications; Type: TABLE DATA; Schema: public; Owner: -
--
...
1	2026-0001	Pedro Aquino	Jake Cuenca	\N	\N	\N	\N	pending_legal_review	\N	1	\N	\N	2026-06-24 20:29:05	2026-07-03 15:27:39	\N	\N	\N	\N	\N	1	\N	\N	Jake Cuenca	transferee	\N	f	\N	\N	\N	2026-06-24	\N	f	f	\N	\N	\N	\N	\N	\N	\N	\N
\.


--
-- Data for Name: landholding_mutations; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: landholdings; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: landowners; Type: TABLE DATA; Schema: public; Owner: -
--
...
1	Pedro	\N	Aquino	\N	\N	\N	\N	\N	Negros Oriental	\N	2026-07-03 15:27:39	2026-07-03 15:27:39	\N	\N
\.


--
-- Data for Name: legacy_record_import_batches; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: legacy_records; Type: TABLE DATA; Schema: public; Owner: -
--
...
44	2026_07_03_073000_remove_duplicate_recent_tax_declaration_requirement	9
45	2026_07_03_081500_remove_remaining_recent_tax_declaration_duplicate	9
\.
...
--
-- Data for Name: required_documents; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: source_record_package_import_batches; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: source_record_packages; Type: TABLE DATA; Schema: public; Owner: -
--
...
2	3	application_created	Clearance application encoded	Application 2026-0001 was encoded and placed under Pending Review by Legal Officer.	App\\Models\\LandTransferApplication	1	{"application_id":1,"application_code":"2026-0001","status":"pending_legal_review","status_label":"Pending Review by Legal Officer","transferor_name":"Pedro Aquino","transferee_name":"Jake Cuenca","municipality":null,"barangay":null}	\N	2026-06-24 20:29:06	2026-06-24 20:29:06
3	4	application_created	Clearance application encoded	Application 2026-0001 was encoded and placed under Pending Review by Legal Officer.	App\\Models\\LandTransferApplication	1	{"application_id":1,"application_code":"2026-0001","status":"pending_legal_review","status_label":"Pending Review by Legal Officer","transferor_name":"Pedro Aquino","transferee_name":"Jake Cuenca","municipality":null,"barangay":null}	\N	2026-06-24 20:29:06	2026-06-24 20:29:06
4	5	application_created	Clearance application encoded	Application 2026-0001 was encoded and placed under Pending Review by Legal Officer.	App\\Models\\LandTransferApplication	1	{"application_id":1,"application_code":"2026-0001","status":"pending_legal_review","status_label":"Pending Review by Legal Officer","transferor_name":"Pedro Aquino","transferee_name":"Jake Cuenca","municipality":null,"barangay":null}	\N	2026-06-24 20:29:06	2026-06-24 20:29:06
1	1	application_created	Clearance application encoded	Application 2026-0001 was encoded and placed under Pending Review by Legal Officer.	App\\Models\\LandTransferApplication	1	{"application_id":1,"application_code":"2026-0001","status":"pending_legal_review","status_label":"Pending Review by Legal Officer","transferor_name":"Pedro Aquino","transferee_name":"Jake Cuenca","municipality":null,"barangay":null}	2026-07-03 15:26:02	2026-06-24 20:29:06	2026-07-03 15:26:02
\.
...
--
-- Name: application_clearances_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.application_clearances_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.application_documents_id_seq', 1, true);


--
-- Name: application_parcels_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.application_parcels_id_seq', 1, false);
...
--
-- Name: land_transfer_applications_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.land_transfer_applications_id_seq', 1, true);


--
-- Name: landholding_mutations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: landholdings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.landholdings_id_seq', 1, false);


--
-- Name: landowners_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.landowners_id_seq', 1, true);


--
-- Name: legacy_record_import_batches_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.legacy_records_id_seq', 1, false);
...
--
-- Name: parcels_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: required_documents_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.source_record_packages_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.system_notifications_id_seq', 4, true);
...
--
-- Name: application_clearances application_clearances_clearance_number_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_documents application_documents_land_transfer_application_id_required_doc; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_parcels application_parcels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications land_transfer_applications_application_code_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications land_transfer_applications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations landholding_mutations_land_transfer_application_id_parcel_id_un; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations landholding_mutations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholdings landholdings_landowner_id_parcel_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholdings landholdings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landowners landowners_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landowners landowners_user_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches legacy_record_import_batches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_records legacy_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: parcels parcels_parcel_code_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches source_record_package_import_batches_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages source_record_packages_package_code_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages source_record_packages_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_clearances uq_application_clearances_application; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: app_docs_application_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: app_parcels_application_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: app_parcels_parcel_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: application_documents_reference_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: application_parcels_parcel_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_application_clearances_status_generated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations_transferor_landowner_id_transferee_landow; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: landholdings_landowner_status_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: landholdings_parcel_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: landowners_last_name_first_name_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches_record_type_status_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_control_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_landowner_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_lot_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_municipality_barangay_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_record_type_origin_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_source_record_package_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_tax_declaration_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_title_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_unique_control_number; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: legacy_records_unique_title_number; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: parcels_municipality_barangay_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches_status_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_control_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_landholding_reference_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_landowner_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_parcel_code_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_parcel_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_status_source_record_scope_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages_title_number_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: system_notifications_read_at_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: system_notifications_related_type_related_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: system_notifications_type_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: system_notifications_user_id_created_at_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: system_notifications_user_id_read_at_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: application_clearances application_clearances_generated_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_clearances application_clearances_land_transfer_application_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_documents application_documents_land_transfer_application_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_documents application_documents_metadata_encoded_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_documents application_documents_required_document_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_documents application_documents_source_record_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_documents application_documents_source_record_package_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_documents application_documents_uploaded_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_parcels application_parcels_land_transfer_application_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: application_parcels application_parcels_parcel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: audit_logs audit_logs_land_transfer_application_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications land_transfer_applications_encoded_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications land_transfer_applications_registry_mutated_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications land_transfer_applications_reviewed_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications land_transfer_applications_transferee_landowner_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: land_transfer_applications land_transfer_applications_transferor_landowner_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations landholding_mutations_land_transfer_application_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations landholding_mutations_mutated_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations landholding_mutations_parcel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations landholding_mutations_transferee_landowner_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholding_mutations landholding_mutations_transferor_landowner_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholdings landholdings_landowner_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholdings landholdings_parcel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landholdings landholdings_source_application_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: landowners landowners_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches legacy_record_import_batches_committed_by_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_record_import_batches legacy_record_import_batches_uploaded_by_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_records legacy_records_encoded_by_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_records legacy_records_landowner_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_records legacy_records_legacy_record_import_batch_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_records legacy_records_parcel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: legacy_records legacy_records_source_record_package_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches source_record_package_import_batches_committed_by_user_id_forei; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_package_import_batches source_record_package_import_batches_uploaded_by_user_id_foreig; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages source_record_packages_encoded_by_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages source_record_packages_landowner_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages source_record_packages_parcel_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: source_record_packages source_record_packages_source_file_uploaded_by_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: system_notifications system_notifications_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict hXwmdUdOsxO5YpvhEZSIzraBzIyvWWaqEdaqe2kEecySsxbGIUSwoUZYRYOdhHm
